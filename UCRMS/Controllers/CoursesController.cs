...
namespace UCRMS.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CourseId,Code,Name,Credit,Description,DepartmentId,SemesterId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CourseId,Code,Name,Credit,Description,DepartmentId,SemesterId")] Course course)
        {
            if (ModelState.IsValid)
            {
